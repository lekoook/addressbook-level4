...
. Finding a person in the address book.
    ...
    `add n/Marcus Tok p/12341234 e/MT@example.com a/123, Admiralty, 1234665 r/Cleaner k/4.0 d/MT is a bad cleaner t/notFriend t/colleague 2`
...
.. Test case: `password hello` +
    Prerequisites: This test case should be carried out after the previous test case *a.* +
...
. Prerequisites: Make sure the address book is populated with people +
. Test case: `export` +
